...
const HomepageSocialList = () => {
  return (
    <div>
      <section className="relative transition duration-500 ease-in-out bg-white rounded-lg px-9 py-7 text-2xs text-syncWave lg:px-10 lg:py-8 lg:text-sm dark:text-white dark:bg-darkModeDetail">
