const HomepageSocialList = () => {
  return (
    <div>
      <section className="relative px-8 py-6 transition duration-500 ease-in-out bg-white rounded-lg text-2xs text-syncWave lg:px-10 lg:py-8 lg:text-sm dark:text-white dark:bg-darkModeDetail">
