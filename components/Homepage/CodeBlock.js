const HomepageSkillsList = () => {
  return (
    <div>
      <section className="relative z-10 px-6 py-4 antialiased transition duration-500 ease-in-out bg-white rounded-lg text-2xs text-syncWave lg:px-10 lg:py-8 lg:text-sm dark:text-slate-200 dark:bg-darkModeDetail">
