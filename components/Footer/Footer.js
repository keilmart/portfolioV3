const Footer = () => {
  ...
  return (
    <footer>
      <div className="container flex justify-end px-6 pt-2 pb-6 mx-auto space-y-3 bg-white border-t border-primary dark:bg-darkMode md:pt-3 md:space-y-0 md:flex-nowrap lg:px-0">
